...
export function Settings() {
  ...
  return (
    <main className="site-shell mx-auto min-h-screen max-w-lg px-4 py-6 sm:px-5">
      ...
      <header className="mt-6"><p className="text-sm font-bold text-[#1f5d3b]">Make the app yours</p><h1 className="mt-1 text-3xl font-bold">Settings</h1><p className="muted-copy mt-2 text-base leading-6">Sajilo Stay uses online AI when a connection is available and falls back to offline tools when it is not.</p></header>
