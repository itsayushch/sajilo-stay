    ...
    <main className="site-shell mx-auto min-h-screen max-w-lg px-4 py-6 sm:px-5">
      ...
      <nav aria-label="Main sections" className="grid gap-3.5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Link href="/chat" className="group block min-h-36 rounded-[1.125rem] border border-[#cce3db] bg-[#edf7f2] p-4 shadow-[0_10px_24px_rgba(22,82,67,0.08)] hover:-translate-y-0.5 hover:border-[#8bbba9] focus-visible:ring-2 focus-visible:ring-[#15506d]"><span className="mb-3 flex h-8 w-8 items-center justify-center rounded-lg bg-[#d3ede1] text-sm font-extrabold text-[#17634d]" aria-hidden="true">↔</span><span className="sign-title block text-lg font-extrabold">Guest messages</span><span className="muted-copy mt-2 block text-xs leading-5">Translate, copy, and share replies.</span></Link>
        </div>
        <Link href="/rooms" className="flex items-center justify-between rounded-xl border border-[#d6e4dd] bg-white/65 px-4 py-3.5 shadow-sm hover:border-[#92b9aa] hover:bg-white focus-visible:ring-2 focus-visible:ring-[#15506d]"><span><span className="sign-title block text-base font-extrabold">Manage rooms</span><span className="muted-copy mt-1 block text-xs">Name rooms and update availability.</span></span><span aria-hidden="true" className="flex h-8 w-8 items-center justify-center rounded-full bg-[#e4f3ec] text-sm text-[#17634d]">⌂</span></Link>
