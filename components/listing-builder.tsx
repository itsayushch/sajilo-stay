...
export function ListingBuilder() {
  ...
  return (
    <main className="site-shell mx-auto min-h-screen max-w-lg px-4 py-6">
      ...
      <header className="mt-6"><p className="text-sm font-bold text-[#1f5d3b]">Tell guests about your home</p><h1 className="mt-1 text-4xl font-bold">Write your stay</h1><p className="muted-copy mt-2 text-base leading-6">Turn rough home notes into a guest-ready description—even offline.</p></header>
